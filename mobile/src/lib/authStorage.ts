...
const ACCESS_TOKEN_KEY = "kitchenplanner_access_token";
const REFRESH_TOKEN_KEY = "kitchenplanner_refresh_token";
const USER_KEY = "kitchenplanner_user";
...
// Generic on-device key/value helpers (web-safe, same SecureStore/localStorage split as
// above) for small local preferences that don't belong on the shared FinanceTracker account.
